...
int main()
{
    ...
    for(i=0; i<5; i++)        //Επανάληψη 5 φορές για τη δημιουργία 5 θυγατρικών διεργασιών, δηλαδή 5 πελατών
    {
        ...
        {       
            sleep(3);    //Αναμονή 3 δευτερόλεπτα για την διαβεβαίωση ότι η πατρική διεργασία έχει προλάβει να δημιουργήσει το socket και να εκτελέσει την συνάρτηση parent_orders
